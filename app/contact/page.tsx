    ...
    return (
        <div className="bg-white min-h-screen pt-20">
            <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
                <div className="mx-auto max-w-lg md:max-w-none md:grid md:grid-cols-1 md:gap-8">
                    <div className="p-12 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50 border border-gray-100">
                        {/* Judul */}
                        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
                            Hubungi Kami
                        </h2>
                        <p className="mt-3 text-lg text-gray-600 leading-relaxed">
                            Kami siap membantu Anda dalam pengelolaan sekolah Islam profesional.
                        ...
                        <div className="mt-10 space-y-6">
                            {/* WhatsApp */}
                            <a
                                href="https://wa.me/6285150733782"
                                target="_blank"
                            ...
                            >
                                ...
                                <div className="ml-4 text-gray-700">
                                    ...
                                    <p className="text-sm text-gray-500">0851-5073-3782</p>
                                </div>
                            </a>

                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/shamsi.id/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center p-4 rounded-xl hover:bg-pink-50 transition"
                            >
                                ...
                                <div className="ml-4 text-gray-700">
                                    ...
                                    <p className="text-sm text-gray-500">@shamsi.id</p>
                                </div>
                            </a>

                            {/* Email */}
                            <a
                                href="mailto:shamsiindonesia@gmail.com"
                                className="flex items-center p-4 rounded-xl hover:bg-blue-50 transition"
                            >
                                ...
                                <div className="ml-4 text-gray-700">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        shamsiindonesia@gmail.com
                                    </p>
                                </div>
                            </a>

                            {/* Telepon (opsional, jika tetap mau tampilkan) */}
                            <div className="flex items-center p-4 rounded-xl hover:bg-gray-50 transition">
                                ...
                                <div className="ml-4 text-gray-700">
                                    ...
                                    <p className="text-sm text-gray-500">Senin–Sabtu 08.00–17.00</p>
                                </div>
                            </div>
                        </div>
                    </div>
